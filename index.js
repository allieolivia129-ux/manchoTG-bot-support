...
setupBot(bot1, "BlockchainFx Support");
console.log("BlockchainFx Support started");

setupBot(bot2, "Live Channel Support");
console.log("Live Channel Support started");

setupBot(bot3, "BlockDag Support");
console.log("BlockDag Support started");

setupBot(bot4, "Beldex Support");
